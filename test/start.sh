...
# 哪吒监控变量
export NEZHA_SERVER=${NEZHA_SERVER:-'nezha.hnhp.eu.org'}       # 哪吒客户端域名或ip
export NEZHA_PORT=${NEZHA_PORT:-'443'}                         # 哪吒端口
export NEZHA_KEY=${NEZHA_KEY:-'IUSS73ffUjEidGBxPH'}            # 哪吒客户端密钥
